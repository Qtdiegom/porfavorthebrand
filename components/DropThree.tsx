...
export default function DropThree() {
  ...
  return (
    <section id="drop-003" className="relative bg-[#080808] py-28 px-6 overflow-hidden border-t border-[#c0392b]/20">
      ...
      {lips.map((l, i) => (
        ...
        >
          ...
          <svg width="80" height="50" viewBox="0 0 80 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M30 20 C34 21 37 24 40 24 C43 24 46 21 50 20 C46 22 43 26 40 26 C37 26 34 22 30 20Z" fill="#080808" opacity="0.4"/>
          </svg>
        </div>
      ))}
      ...
      <div className="relative z-10 max-w-7xl mx-auto" ref={ref}>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
          {products.map((p, i) => (
            <motion.a
              ...
              className={`group relative bg-[#0d0d0d] border border-[#1a1a1a] hover:border-[#c0392b] transition-all duration-300 overflow-hidden ${
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group flex items-center gap-3 bg-[#c0392b] text-[#f0ead6] font-dm font-bold text-[11px] tracking-[0.2em] uppercase px-8 py-4 hover:bg-[#f0ead6] hover:text-[#080808] transition-colors duration-200"
          >
            SHOP DROP 003
